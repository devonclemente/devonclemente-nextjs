...
import MiroProblemCards from "./MiroProblemCards";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.devonclemente.com/miro-ai-project",
    type: "website",
  ...
  alternates: { canonical: "https://www.devonclemente.com/miro-ai-project" },
};
...
export default function MiroAiProjectPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Problems Identified — client component (expandable cards) */}
      <MiroProblemCards />
