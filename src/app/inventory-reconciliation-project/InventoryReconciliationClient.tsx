...
export default function InventoryReconciliationClient() {
  return (
        ...
        <div className="grid gap-8 pb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="list-disc pl-4 text-muted-foreground space-y-1">
                  ...
                  <li>OpenAI GPT-4o Vision API</li>
          ...
          <Card className="p-6">
            ...
            <div className="text-muted-foreground space-y-4">
              <p>
                The automation workflow leverages Make.com&apos;s automation platform combined with OpenAI&apos;s advanced vision capabilities for intelligent document data extraction processing:
              </p>
          ...
          <div className="flex justify-center py-8">
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Interactive Workflow</DialogTitle>
                  <DialogDescription>
                    Coming soon! The interactive workflow visualization is currently being developed.
                  </DialogDescription>
                </DialogHeader>
              </DialogContent>
            </Dialog>
